export default function Answer() {
	return (
		<>
			<h1 className="text-2xl font-bold mb-6"> 3. Describe how you solved a challenge or technical issue that you faced in a previous role (preferably in a previous support role). How did you determine that your solution was successful?</h1>
				<p className="mb-2">When I worked for a company called TEEG in Australia, I often worked weekend shifts alone. On one particular weekend, the company launched a special &quot;double dollar&quot; promotion, requiring manual adjustments in every point of sale (POS) system across all venues to be performed by the venue staff.This necessitated the staff modifying system files to alter on-screen elements and functionalities, thereby enabling customers to double the money they deposited.</p>
				...
				<p className="mb-2">Realising that remotely accessing each POS system and manually configuring the promotion would be excessively time-consuming in such a time-sensitive situation, I instead created a script that could be dispatched to each POS system, automating all the necessary steps for setting up the promotion correctly.</p>
