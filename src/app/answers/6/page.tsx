export default function Answer() {
	return (
		<>
			<h1 className="text-2xl font-bold mb-6">6. The customer from question 5 replies to your response with the below: “I&apos;m so frustrated. I&apos;ve been trying to make this work for hours and I just can&apos;t figure it out. It must be a platform issue so just fix it for me instead of asking me questions.” Please write a follow-up reply to the customer. </h1>
