export default function Answer() {
    ...
    <div>
        ...
        <ol className="list-decimal ml-6 mb-6">
            <li className="mb-2"><strong>Work with the product team to develop a new feature based on feedback from customers:</strong> Throughout previous roles, I&apos;ve always found joy in optimising and improving the product or workflow for my team and customers. I enjoy sitting with customers, discussing their day-to-day workflow, and seeing how I could improve it for them.</li>
            ...
            <li className="mb-2"><strong>Write and maintain support articles and docs pages:</strong> Having worked at small startup organisations, I have truly learned the value of good documentation. It becomes an invaluable tool to explain to new and existing staff how to perform essential procedures and is invaluable for training, allowing for individual knowledge to be shared with the team.</li>
        </ol>
