export default function Answer() {
	return (
		<>
			<h1 className="text-2xl font-bold mb-6">4. When would you choose to use Edge Functions, Serverless Functions, or Edge Middleware with Vercel?</h1>

  			<h2 className="text-xl font-semibold mb-4">Edge Functions</h2>
  			...
  			<h2 className="text-xl font-semibold mb-4 mt-6">Serverless Functions</h2>
  			...
  			<h2 className="text-xl font-semibold mb-4 mt-6">Edge Middleware</h2>
